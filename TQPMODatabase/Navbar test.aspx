<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Navbar test.aspx.cs" Inherits="TQPMODatabase.Navbar_test" %>
                                ...
                                <div class="navbar-collapse collapse in" id="bs-example-navbar-collapse-1 " aria-expanded="true" style="">
                                    <ul id="navbar-main-menu" class="nav navbar-nav navbar-main-menu col-lg-12" role="tablist" aria-multiselectable="true" style="">
                                        ...
                                        <li class="dropdown main-nav-dropdown-container col-lg-2" data-menu-item-index="1" style="">
                                            ...
                                            <a id="label24" role="button" href="#" class="visible-md visible-lg desktop collapsed" aria-expanded="false" data-toggle="collapse" data-parent="#header-collapse-group" data-target="#dropdown-menu-1" aria-controls="#dropdown-menu-1" data-collapse-group="colHeader" style="">
                                                <%--  <span class="glyphicon glyphicon-menu-right"></span>--%>

                                            </a>

                                            <a id="label25" role="button" href="#" class="visible-xs visible-sm dropdown-toggle main-nav-dropdown-toggle mobile link-chevron secondary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
                                        </li>
                                        <li class="dropdown main-nav-dropdown-container col-lg-2" data-menu-item-index="2" style="">
                                            <a id="label20" role="button" href="#" class="visible-md visible-lg desktop collapsed" aria-expanded="false" data-toggle="collapse" data-parent="#header-collapse-group" data-target="#dropdown-menu-2" aria-controls="#dropdown-menu-2" data-collapse-group="colHeader">
                                                <%-- <span class="glyphicon glyphicon-menu-right"></span>--%>

                                            </a>

                                            <a id="label21" role="button" href="#" class="visible-xs visible-sm dropdown-toggle main-nav-dropdown-toggle mobile link-chevron secondary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
                                        </li>
                                        <li class="dropdown main-nav-dropdown-container col-lg-2" data-menu-item-index="3" style="">
                                            <a id="label22" role="button" href="#" class="visible-md visible-lg desktop" aria-expanded="true" data-toggle="collapse" data-parent="#header-collapse-group" data-target="#dropdown-menu-3" aria-controls="#dropdown-menu-3" data-collapse-group="colHeader">
                                                <%--    <span class="glyphicon glyphicon-menu-right"></span>--%>

                                            </a>

                                            <a id="label23" role="button" href="#" class="visible-xs visible-sm dropdown-toggle main-nav-dropdown-toggle mobile link-chevron secondary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
                                        </li>
                                        <li class="dropdown main-nav-dropdown-container col-lg-2" data-menu-item-index="4" style="">
                                            <a id="label26" role="button" href="#" class="visible-md visible-lg desktop collapsed" aria-expanded="false" data-toggle="collapse" data-parent="#header-collapse-group" data-target="#dropdown-menu-4" aria-controls="#dropdown-menu-4" data-collapse-group="colHeader">
                                                <%--  <span class="glyphicon glyphicon-menu-right"></span>--%>

                                            </a>

                                            <a id="label27" role="button" href="#" class="visible-xs visible-sm dropdown-toggle main-nav-dropdown-toggle mobile link-chevron secondary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
                                        </li>
                                        <%--<li class="col-lg-2" style="border-style: solid; border-color: blue; height:25px;">
