<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserCMTSGridControl.ascx.cs" Inherits="TQPMODatabase.WebUserCMTSGridControl" %>
...
<script>  
    ...
    window.onload = function () {
        ...
        for (let mth = 0; mth < 13; mth++) {
            ...
            if (mth + 1 < currentMonth) {
                ...
                let txt5 = "MainContent_WebControlCMTSGrid_GridView1b_TextBox5_" + mth;
                let txt6 = "MainContent_WebControlCMTSGrid_GridView1b_TextBox6_" + mth;
                let txt7 = "MainContent_WebControlCMTSGrid_GridView1b_TextBox7_" + mth;
                let txt8 = "MainContent_WebControlCMTSGrid_GridView1b_TextBox8_" + mth;
    ...
    function NullAllValuesClick() {
        ...
        for (let column = 8; column < 14; column++) {
            for (let mth = 1; mth < 13; mth++) {
                if (mth >= currentMonth) {
                    let TextBox5 = "MainContent_WebControlCMTSGrid_GridView1b_TextBox5_" + (mth - 1);
                    let TextBox6 = "MainContent_WebControlCMTSGrid_GridView1b_TextBox6_" + (mth - 1);
                    let TextBox7 = "MainContent_WebControlCMTSGrid_GridView1b_TextBox7_" + (mth - 1);
                    let TextBox8 = "MainContent_WebControlCMTSGrid_GridView1b_TextBox8_" + (mth - 1);
    ...
    function GetSelectedRow(lnk) {
        ...
        let TextBox5 = "MainContent_WebControlCMTSGrid_GridView1b_TextBox5_" + row;
        let TextBox6 = "MainContent_WebControlCMTSGrid_GridView1b_TextBox6_" + row;
        let TextBox7 = "MainContent_WebControlCMTSGrid_GridView1b_TextBox7_" + row;
        let TextBox8 = "MainContent_WebControlCMTSGrid_GridView1b_TextBox8_" + row;
        ...
        for (let column2 = 8; column2 < 9; column2++) {
            for (let row22 = 1; row22 < 13; row22++) {
                ...
                if (row22 < currentMonth) {
                    ...
                    let TextBox5bb = "MainContent_WebControlCMTSGrid_GridView1b_TextBox5_" + (row22 - 1);
        ...
        for (let column2 = 9; column2 < 10; column2++) {
            for (let row22 = 1; row22 < 13; row22++) {
                ...
                if (row22 < currentMonth) {
                    ...
                    let TextBox6bb = "MainContent_WebControlCMTSGrid_GridView1b_TextBox6_" + (row22 - 1);
        ...
        for (let column2 = 10; column2 < 11; column2++) {
            for (let row22 = 1; row22 < 13; row22++) {
                ...
                if (row22 < currentMonth) {
                    ...
                    let TextBox7bb = "MainContent_WebControlCMTSGrid_GridView1b_TextBox7_" + (row22 - 1);
        ...
        for (let column2 = 12; column2 < 13; column2++) {
            for (let row22 = 1; row22 < 13; row22++) {
                ...
                if (row22 < currentMonth) {
                    ...
                    let TextBox8bb = "MainContent_WebControlCMTSGrid_GridView1b_TextBox8_" + (row22 - 1);
...
<div class="col-lg-12" style="display: inline-block;">
    ...
    <script>
        ...
        if (<%=language%> == "1") {
            document.getElementById('MainContent_WebControlCMTSGrid_Label14').innerHTML = "Rapports";
        } else {
            document.getElementById('MainContent_WebControlCMTSGrid_Label14').innerHTML = "Reports";
        }
    </script>
    <div class="col-lg-1">
    ...
    <script>  
        ...
        if (<%=language%> == "1") {
            document.getElementById('MainContent_WebControlCMTSGrid_Label15').innerHTML = "Ajustements";
        } else {
            document.getElementById('MainContent_WebControlCMTSGrid_Label15').innerHTML = "Adjustments";
        }
    </script>
    <div class="col-lg-1"></div>
</div>
